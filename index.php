...
<body>
    <nav class="navbar navbar-light navbar-expand-lg fixed-top bg-white clean-navbar">
        <div class="container"><a class="navbar-brand logo" href="#">Brand<div><h4><?php echo date() ?></h4></div></a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="product-page.html">página do produto</a></li>
                    <li class="nav-item"><a class="nav-link" href="contact-us.html">Contato</a></li>
                    <li class="nav-item"><a class="nav-link" href="registration.html">cadastro</a></li>
                    <li class="nav-item"><a class="nav-link" href="shopping-cart.html">carrinho</a></li>
                </ul>
            </div>
        </div>
    </nav>
    <main class="page landing-page">
        ...
        <section class="clean-block clean-hero" style="background-image:url(&quot;assets/img/tech/image4.jpg&quot;);color:rgba(9, 162, 255, 0.85);">
            <div class="text">
                <h2>Texto sobre alguma coisa !</h2>
                <p>Bla bla bla bla .... coisas aqui texto</p><button class="btn btn-outline-light btn-lg" type="button">Saiba mais</button>
            </div>
        </section>
            ...
            <div class="container">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6">
                        ...
                        </div><button class="btn btn-outline-primary btn-lg" type="button">Entrar agora</button>
                    </div>
                </div>
            </div>
        </section>
